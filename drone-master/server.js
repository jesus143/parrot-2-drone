...
io.on('connection', function(socket) {
    ...
    pngStream.on('data', function(videoBuffer) {
            ...
            var now = (new Date()).getTime(); 
                ...
                fs.writeFile('C:/laragon/www/drone/drone-master/public/drone/img/frame-' + frameCounter + '.png', videoBuffer, function(err) {
            ...
            if(frameCounter % 5000 == 0) {
                ...
                setTimeout(function () {
                    rimraf("C:/laragon/www/drone/drone-master/public/drone/img/*", function () {
